...
export default function PaymentHis() {
    ...
    const getPayment = async () => {
        try {
            const res = await axios.get(`${process.env.REACT_APP_BACKEND_BASE_URL}/PaymentHistory/${id}`)
            if (res.status === 200) {
                        ...
                        : <>
                            <form className="woocommerce-cart-form mt-5">
                                ...
                                <table className="cart_table">
                                    <thead>
                                        <tr>
                                            <th className="cart-col-image">Date</th>
                                            <th className="cart-col-productname">Payment Status</th>
                                                    ...
                                                    <tr className="cart_item" key={index}>
                                                        <td data-title="Name">
                                                            <div className="cart-productname">
                                                                {new Date(dataa.date).toISOString().split('T')[0]}
                                                            </div>
                                                        </td>
                                                        <td data-title="Price">
                                                            <span className="amount">
                                                                {dataa.payment_status === 1 ? 'Done' : "Padding"}
                                                            </span>
                                                        </td>
                                                        <td data-title="Total">
                                                            <span className="amount">
                                                                {location === "IN" ? "₹" + dataa.total_rupees : "$" + dataa.total_doller}
                                                            </span>
                                                        </td>
                                                    </tr>
                                                );
