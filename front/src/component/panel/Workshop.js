    ...
    const handleDelete = async (id) => {
        try {
            ...
            if (result.isConfirmed) {
                const res = await axios.delete(`${process.env.REACT_APP_BACKEND_BASE_URL}/delete/workshop/` + id);
                if (res.status === 200) {
                    getStudentData();
                    Swal.fire({
                        title: "Deleted!",
                        text: "This Workshop has been deleted.",
                        icon: "success",
                ...
                <div className="page-wrapper page-settings">
                    <div className="content">
                        ...
                        <div className="d-flex justify-content-between">
                            ...
                            <div className="form-group">
                                <Link to="/create-workshop"><button className="btn btn-primaryy">create</button></Link>
                            </div>
                        </div>
                        <div className="row">
