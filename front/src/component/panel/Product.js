    ...
    const handleDelete = async (id) => {
        try {
            ...
            if (result.isConfirmed) {
                const res = await axios.delete(`${process.env.REACT_APP_BACKEND_BASE_URL}/delete/product/` + id);
                if (res.status === 200) {
                    getProductData();
                    Swal.fire({
                        title: "Deleted!",
                ...
                <div className="page-wrapper page-settings">
                    <div className="content">
                        ...
                        <div className="d-flex justify-content-between">
                            ...
                            <div className="form-group">
                                <Link to="/createproduct"><button className="btn btn-primaryy">create</button></Link>
                            </div>
                        </div>
                        <div className="row">
                                        ...
                                        {currentItems.length === 0 ? (
                                            ...
                                            currentItems.map((dataa, index) => (
                                                <tr key={index}>
                                                    ...
                                                    <td>{dataa.title}</td>
                                                    <td>{dataa.description.split('').slice(0, 20).join("") + "..."}</td>
                                                    <td>{dataa.amount}</td>
                                                    <td>{dataa.size}</td>
                                                    <td>
