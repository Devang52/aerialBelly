...
export default function CreateEvent() {
  ...
  const headleSubmit = async (e) => {
    ...
    try {
      ...
      if (!trimmedEvent.title || !trimmedEvent.description || !trimmedEvent.address || !event.date || !event.photo) {
        Swal.fire({
        ...
        const res = await axios.post(`${process.env.REACT_APP_BACKEND_BASE_URL}/createevent`, formDataObject);
