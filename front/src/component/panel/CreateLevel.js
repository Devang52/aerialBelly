    ...
    const headleSubmit = async (e) => {
        ...
        try {
            ...
            if (!trimmedEvent.title || !trimmedEvent.description) {
                ...
                const res = await axios.post(`${process.env.REACT_APP_BACKEND_BASE_URL}/createlevel`, data);
                                ...
                                <div className="col-lg-12 col-sm-12">
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="btn-path">
                                            <Link to={'/level'} className="btn btn-cancel me-3">Back</Link>
