...
export default function CreateWorkshop() {
    ...
    const headleSubmit = async (e) => {
        ...
        try {
            ...
            if (!trimmedWorkshop.title || !trimmedWorkshop.city || !trimmedWorkshop.location || !trimmedWorkshop.description || !workshop.date || !workshop.photo) {
                Swal.fire({
                ...
                const res = await axios.post(`${process.env.REACT_APP_BACKEND_BASE_URL}/createWorkshop`, formDataObject);
